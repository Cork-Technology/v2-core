...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    address public dsFlashSwapRouter;

    function feeApplied() internal view returns (bool) {
        return msg.sender != dsFlashSwapRouter;
    }
    ...
    function initialize(address _token0, address _token1, address _flashSwapRouter) external {
        require(msg.sender == factory, 'UniswapV2: FORBIDDEN'); // sufficient check
        token0 = _token0;
        token1 = _token1;
        dsFlashSwapRouter = _flashSwapRouter;
    }
